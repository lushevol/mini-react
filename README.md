最新的请查看 React 源码学习指南.md

源码文件指引地址：https://www.processon.com/view/link/60b206c2e0b34d3841931a88
...
**最新的 react 包只需要修改下面的 1、2、3、6、7。（2021.7.27）**
...
2）搜索 no-function-declare-after-return 和 react-internal，把相关的代码行全部注释掉。

3）搜索 eol-last，把` 'eol-last': ERROR,`的 ERROR 改为 OFF

4）搜索 quotes，把 quotes 和 jsx-quotes 的值也修改为 OFF

5）搜索 no-unused-vars，把 no-unused-vars 的值也改为 OFF
